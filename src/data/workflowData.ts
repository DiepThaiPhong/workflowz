...
// ─── Workflow 7: Cài đặt Openclaw trên VPS ───────────────────────────────────
export const WORKFLOW_CURSOR: Workflow = {
  id: 'wf-cursor-landing',
  title: 'Cài Đặt Openclaw (Clawdbot) Trên VPS',
  titleEn: 'Install Openclaw (Clawdbot) on VPS',
  description: 'Hướng dẫn cài đặt và thiết lập trợ lý AI Openclaw trên VPS từ A-Z. 6 bước đơn giản – bot hoạt động 24/7.',
